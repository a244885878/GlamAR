...
class FaceDetectorProcessor {
  ...
  /// Creates the detector from a model already materialized by the root
  /// isolate. This keeps asset-channel access out of inference isolates.
  static Future<FaceDetectorProcessor> createFromModelPath(
...
class FaceMeshProcessor {
  ...
  static Future<FaceMeshProcessor> create({
    ...
    return createFromModelPath(
      resolvedModelPath,
      irisModelPath: resolvedIrisModelPath,
      threads: threads,
      minDetectionConfidence: minDetectionConfidence,
      minTrackingConfidence: minTrackingConfidence,
      enableSmoothing: enableSmoothing,
      enableRoiTracking: enableRoiTracking,
  ...
  /// Creates Face Mesh from files prepared by the root isolate. Passing a
  /// concrete path avoids `rootBundle`/`ServicesBinding` on worker isolates.
  static Future<FaceMeshProcessor> createFromModelPath(
    String resolvedModelPath, {
    String? irisModelPath,
    int threads = 2,
    double minDetectionConfidence = 0.5,
    double minTrackingConfidence = 0.5,
    bool enableSmoothing = true,
    ...
    if (enableIris && irisModelPath == null) {
      throw ArgumentError('irisModelPath is required when enableIris is true.');
    }
    final resolvedIrisModelPath = irisModelPath;
